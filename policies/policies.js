...
module.exports=[
  ...
  //projects
  {"api" : "/projects", "method" : "get", "groups" : [GROUPS.super_admin, GROUPS.founder, GROUPS.cofounder , GROUPS.member,GROUPS.registered_user, GROUPS.mentor, GROUPS.supervisor_project]},
  {"api" : "/projects/:id", "method" : "get", "groups" : [GROUPS.super_admin, GROUPS.founder, GROUPS.cofounder, GROUPS.member, GROUPS.mentor, GROUPS.supervisor_project]},
  {"api" : "/projects", "method" : "post", "groups" : [GROUPS.registered_user, GROUPS.founder, GROUPS.cofounder,GROUPS.member]},
