...
exports.findByview = function(designDocument,viewName){
	  return new Promise((resolve, reject)=>{
	    db.view(designDocument,viewName, function(err, data) {
			  if (!err) {
	        return resolve(data);
	      }
	      reject(err);
...
//	exports.findByviewList = function(designDocument,viewName,ListFunction){
//		  return new Promise((resolve, reject)=>{
//		    db.view(designDocument,viewName,ListFunction, function(err, data) {
//				  if (!err) {
//		        return resolve(data);
//		      }
//		      reject(err);
