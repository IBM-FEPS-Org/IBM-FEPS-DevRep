...
function clinicIssueDoc(doc) {
	  if(doc.type == "clinicIssue") {
	      emit(doc.title,{"_id":doc._id,"_rev":doc._rev,"user": doc.user, "date" : doc.date, "title" : doc.title, "summary":doc.summary, "description" : doc.description, "status" : doc.status});
	  }
}
