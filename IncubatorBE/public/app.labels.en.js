var appLabelsEn = {
	 ...
	 //about us
		...
		aboutusVisionText:"To be a Center of Excellence and a Hub for the best Entrepreneurial Practices in Public Universities in Egypt, the Middle East, and North Africa.",
		aboutusMission:"Our Mission",
		aboutusMissionText:"As a center of Excellence and hub for Entrepreneurship, we aim to empower a generation of start-ups who can dynamically support Egypt’s economic growth, through providing diversified entrepreneurial services for Egyptian youth, ages 18 to 35 years old. FEPS Business Incubator provides start-ups with three main services: Awareness Sessions, Incubation Service, and Business Clinic.",
		aboutusTeam:"Our Team",
		aboutusTeamText:"We, at the Faculty of Economics & Political Science Business Incubator (FEPS BI), have highly motivated professionals, whose knowledge and expertise ensure an effective and efficient work environment. Our team members are capable of implementing our finely crafted strategy that aims to support young Egyptian startups.",
		...
		aboutusMemeberRole10:"Web Developer",
		aboutusMember11:"Nahed Taha",
		aboutusMemeberRole11:"Web Master officer",
		
     //news and events listView Mfarag
        newsEventsListTitle:"News & Events",
		newsListTitle:"News",
		eventsListTitle:"Events",
		unsubscribeEventsTitle:"Unsubscribe Email",
		unsubscribe:"Unsubscribe",
		LoginToUnsubscribeMsg: "to unsubscribe your email",
		unsubscribedSuccessfullyMsg:"Your email is unsubscribed successfully.",
		unsubscribeText1: "You are requesting to unsubscribe",
		unsubscribeText2: " from receiving future email messages.",
		unsubscribeText3: "By clicking the button below, You’ll be unsubscribed from the website mailing list but if you’re a FEPS graduate or student you will still receive emails.",
		subscribeEventsTitle:"Subscribe Emails",
	...
	//Advisory Board
	 ...
	 //Add Project
		paragraph1Header:"FEPS Business Incubator is delighted to open its 2nd " +
						"Business incubation cycle; a 4-month program that includes:",
		paragraph1a: "Mentor-centric Incubation program with 40+ experienced mentors.",
		paragraph1b: "Variety of perks in partnerships with community partners ",
		paragraph1c: "Incubation program hosted at the prestigious Cairo University",
		paragraph1d: "Access to co-working space",
		paragraph1e: "Financial Prize up to 50,000 L.E with Zero Equity, from EGBank ",
		
		paragraph2Header:"Before you apply, your startup has to have to the following:",
		paragraph2a: "The startup must have at least 2 co-founders, and they must attend the 5 days bootcamp upon being shortlisted,",
		paragraph2b: "Team members should be up to 35 years old,",
		paragraph2c: "Team members should have at least one year of professional experience,",	
		paragraph2d: "The startup must have at least one co-founder with professional/technical expertise in the industry of choice,",	
		paragraph2e: "The startup should have at least one team member dedicated for 12 hours per week to commit to working on the startup, attending weekly updates meetings, trainings & mentorship sessions,",	
		paragraph2f: "The startup must have revenue generating model with clear potentially for growth nationally or regionally.",
		paragraph2g: "A Proof of Concept and/or Validated Prototype must be submitted,",	
		
		
		Error_Msg_Max_length: "Only alphabets and special characters, min 2 max 4000 are allowed",
		addProject:"Add Project",
		theTeam:"The Founding Team",
		teamLabel:"Please insert below your Team members specifying their role/title in the startup, " +
				"team should have at least; 2 co-founders and one of them with technical expertise in the industry of choice.",
		teamNo:"",
		founderName:"Founder's Name",
		founderAge:"Founder's Age",
		founderEmail:"Founder's Email",
		founderPhone:"Founder's Phone",
		founderGender:"Founder's Gender",
		founderLinkedin:"Founder's Linkedin",
		founderLocation:"Founder's Location",
		founderQuestion1:"What is your highest level of education?",
		founderQuestion2:"What is your area of expertise?",
		founderQuestion3:"What is your most impressive accomplishment?",
		founderQuestion4:"Are you currently part-time or full-time on this startup?",
		roleinProject:"Role in Project",
		proofofAffiliation:"Proof of Affiliation",
		teamMembers:"Startup Team Members",
		addMember:"Add Member",
		addMemberLabel:"All Members must be registerd users on the website",
		projectFounder:"Project Founder",
		memberName:"Username",
		memberFName:"Name",
		uploadFile:"Upload File",
		addprojectFileLarge:"File too large ,max 2000KB",
		...
		founderLocationRequired:"Founder Loaction is required",
		founderLinkedinRequired:"Founder Linkedin is required",
		...
		developmentStage_Error_Msg: "Development Stage is required.",
		question1:"Is your business currently legally registered?",
		question2:"Describe your company in a sentence or two. (What, for whom and how?) (200 characters)",
		question3:"What is the product/service you are building?",
		question4:"Why did you pick to work on this idea?",
		question5:"What have you achieved so far? How did you validate your idea/prototype?",
		question6:"Who is your customer & What is your target market? ",
		question7:"Do you have any existing clients or users?",
		question8a:"Startup Website link (If available)",
		question8b:"Startup Social media links (If available)",
		question8bLabel:"(NOT A PERSONAL ACCOUNT)",
		question8c:"Startup Mobile App links (If available)",
		question9:"How do you generate revenues? How do you make money?",
		question10:"Who are your main competitors? locally, regionally or globally ",
		question11:"What expertise are currently available within your team both technical and business development wise?",
		question12:"What are your growth plans? ",
		question13:"What are the challenges you are currently facing?  ",
		question14:"What makes your project/solution valuable and innovative? Why should your Startup be chosen to be incubated at FEPS BI?",
		question15:"Have you participated in or won any previous competitions? ",
		question15Labela: "(i.e. technical competitions, startup development competitions).",
		question15Labelb: "If yes, please list them with dates.",
		...
		documentationLabel: "Please upload any supporting documentation you would like to include in your application. You can upload up to 5 files (Documents, Presentations, PDFs and Images) with a maximum on 10 MB each.",
		showcaseRequired:"You must include a video",
		showcasevalidate:"Invalid url",
		add:"Add",
		edit:"Edit",
		...
		addProjectPrototype:"Provide a validated prototype or/and proof of concept",
		addProjectPrototypeDescription:"A prototype is a test or preliminary model of an idea, design, process, interface, technology, product, service or creative work. You could upload a Word,PDF, drawing, simulation, Photo, visual design, application, storyboard. ** Allowed files: Images,word,powerpoint,excel,pdf,rar,zip",
    ...
    //briefCase landing and events Mfarag
        ...
        /*manage Cycle mFarag*/
            ...
            manageCycleMainTitle:"Manage Cycles",
            manageCycleGeneralCycle: "General Cycle",
            manageCycleHerCycle: "Her Cycle",
            manageCycleAddCycleBtn:"Add Cycle",
            manageCycleAddHerCycleBtn:"Add Her Cycle",
	...
	/*Assign Mentor*/
		...
		// addEvent
			...
			eventEmailRecipients:"Email Recipients",
			eventEmailRecipients1:"Students",
			eventEmailRecipients2:"Graduates",
			eventEmailRecipients3:"Both",
			eventCertificateYes: "Yes",
			eventCertificateNo: "No",
			eventProvideCertificate: "Attendees will get a credited certificate from Cairo University",
